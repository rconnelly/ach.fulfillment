...
namespace Ach.Fulfillment.Scheduler.Configuration
{
	...
	public class Configuration
	{
        ...
        private const string DefaultServiceName = "AchFulfillmentSchedulerServer";
        private const string DefaultServiceDisplayName = "AchFulfillmentSchedulerServer";
        private const string DefaultServiceDescription = "AchFulfillment Scheduler Job Scheduling Server";
