namespace Ach.Fulfillment.Nacha.Record
{
    ...
    public class FileHeaderRecord : SerializableBase
    {
        ...
        /// </remarks>
        [Field(Position = 2, DataType = DataType.Alphanumeric, Length = 10, IsRequired = true, MaskOnAudit = false,
            PaddingType = PaddingType.SpacePadLeft)]
        ...
        /// </summary>
        [Field(Position = 4, DataType = DataType.Date, Length = 10, IsRequired = true, MaskOnAudit = false,
            FormattingString = "yyMMddHHmm")]
        ...
        /// </summary>
        [Field(Position = 6, DataType = DataType.Numeric, Length = 3, IsRequired = true, MaskOnAudit = false,
            PaddingType = PaddingType.Default)]
        internal long RecordSize = 94;

        /// <summary>
        /// Number of records per block
        /// </summary>
        [Field(Position = 7, DataType = DataType.Numeric, Length = 2, IsRequired = true, MaskOnAudit = false,
            PaddingType = PaddingType.Default)]
        ...
        /// </list>
        /// </value>
        [Field(Position = 9, DataType = DataType.Alphanumeric, Length = 23, IsRequired = true, MaskOnAudit = false,
            PaddingType = PaddingType.Default)]
        ...
        /// </summary>
        [Field(Position = 10, DataType = DataType.Alphanumeric, Length = 23, IsRequired = true, MaskOnAudit = false,
            PaddingType = PaddingType.Default)]
        public string OriginOrCompanyName { get; set; }
        ...
        /// </summary>
        [Field(Position = 11, DataType = DataType.Alphanumeric, Length = 8, IsRequired = false, MaskOnAudit = false,
            PaddingType = PaddingType.Default)]
