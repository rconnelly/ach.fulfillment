namespace Ach.Fulfillment.Nacha.Record
{
    ...
    public class FileControlRecord : SerializableBase
    {
        ...
        public long EntryAndAddendaCount { get; set; }
        ...
        /// </summary>
        [Field(Position = 5, DataType = DataType.Numeric, Length = 12, IsRequired = true, MaskOnAudit = false,
            Scale = 100)]
        ...
        /// </summary>
        [Field(Position = 6, DataType = DataType.Numeric, Length = 12, IsRequired = true, MaskOnAudit = false,
            Scale = 100)]
